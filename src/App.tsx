...
function App() {
  ...
  //this will trim the expression just to make sure we dont get any spaces.
  ...
  const buttonPress = (symbol: string) => {
    ...
    if(symbol === "clear"){
      ...
      //Split byoperator and get the last number
      const lastNumber = expression.split(/[-+/*]/g).pop();
      //If the last number already has a decimal then dont add another
  ...
  const calculate = () => {
    //If the last character is an operator then do nothing
